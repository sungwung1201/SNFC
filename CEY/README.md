...
<h2>조의연 담당 작업 타임라인 (데이터 수집 및 환경 구축)</h2>
...
<h2>조의연 담당 작업 타임라인 (데이터 전처리 및 증강)</h2>
...
<h2>조의연 담당 작업 타임라인 (ROS 2 연동 및 다중 로봇 시연)</h2>
...
<h2>조의연 담당 작업 타임라인 (파지 안정화 및 Spawn/Despawn)</h2>
...
5월 26일부터 6월 초까지는 Isaac Sim 환경 구축, VR 조작 인터페이스, HDF5 녹화 파이프라인을 구현하고 슬롯 1~4에 걸쳐 400여 개의 고품질 시연 데이터를 직접 수집하였다. freeze_idle_arms, create_subset, augment_data 등 전처리 및 증강 파이프라인을 구축하여 학습 데이터 품질을 적화하고, Google Colab A100 환경에서 Vision-ACT 모델을 150 epoch 학습하였다.
